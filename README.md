...
### Datos Disponibles
* Archivo de Picos: Contiene información sobre las regiones de unión de los 144 factores de transcripción. Se organiza en las siguientes columnas:
...
Desarrollo del Extractor de Secuencias: Programación de la tarea que consiste en genera los archivos FASTA a partir del archivo de picos. Como es un proceso automatizado, todos la información requerida para ejecutar los programas debe ser por línea de comandos.
Automatización del Análisis con meme: Scripting del proceso de ejecución del análisis de motivos para cada TF.
...
Despliegue y Capacitación: Implementación del sistema en el servidor del colaborador y capacitación de usuarios sobre su uso.
